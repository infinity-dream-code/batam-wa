            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body mt-2">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="mb-2">Selamat Datakmng!</h4>
                                <p class="mb-4">Silahkan login terlokokoebih dahulu</p>
                            </div>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{route('login')}}" method="POST">
                            ...
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="text" placeholder="Masukkan username atau email akun anda" id="username"
                            ...
                            <div class="mb-3">
                                <div class="input-group input-group-merge">
                                    ...
                                    <span class="input-group-text  rounded-end cursor-pointer showPassword"
                            ...
                            <div class="mb-3">
                                <input type="submit" value="Login" class="btn btn-primary d-grid w-100">
                            </div>
                        </form>
                    </div>
                </div>
