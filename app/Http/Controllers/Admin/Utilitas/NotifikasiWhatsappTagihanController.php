...
class NotifikasiWhatsappTagihanController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        if (count($filters) < 1) {
            ...
            $totalRecords = ScctBillModel::select("count(*) as allcount")
            ...
            // dd($columnName, $groupBy, $start, $rowperpage, $columnSortOrder, $filterQuery,);
    ...
    public function index()
    {
        ...
        $data["columnsUrl"] = route(
            "admin.notifikasi-whatsapp-tagihan.get-column",
        );
    ...
    public function sendWhatsapp(Request $request)
    {
        ...
        if ($tagihan == null) {
            return response()->json(
                ["error" => true, "message" => "tidak ada data yang dipilih"],
                422,
            );
        }
